<template>
  <div class="approval-page">
    ...
    <system-dialog :title="approvalDialog.title" :visible="approvalDialog.visible" :width="approvalDialog.width"
      ...
      <div slot="content">
        <el-form :model="formData" ref="personalFrom" label-width="80px" :inline="false" size="small" :rules="rules2">
    ...
    <system-dialog :title="familyDialog.title" :visible="familyDialog.visible" :width="familyDialog.width"
      ...
      <div slot="content">
        <el-form :model="family" ref="familyFrom" label-width="80px" :inline="false" size="small" :rules="rules">
          <el-form-item label="姓名" prop="name">
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        relation: [{required: true, trigger: 'change', message: '请输入与本人的关系'}],
        work: [{required: true, trigger: 'change', message: '请输入工作'}],
        nowJob: [{required: true, trigger: 'change', message: '请输入职务'}],
      },
      rules2: {
        name: [{required: true, trigger: 'change', message: '请输入姓名'}],
        ...
        birthday: [{required: true, trigger: 'change', message: '请选择出生年月'}],
        education: [{required: true, trigger: 'change', message: '请选择教育程度'}],
        birthplace: [{required: true, trigger: 'change', message: '请输入籍贯'}],
        nation: [{required: true, trigger: 'change', message: '请输入民族'}],
        politics: [{required: true, trigger: 'change', message: '请选择政治面貌'}],
        marriage: [{required: true, trigger: 'change', message: '请选择婚姻情况'}],
      },
      basicId: '',
      size: '',
      basicList: {},
