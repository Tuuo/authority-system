      ...
      <div slot="content">
        <el-form :model="group" ref="groupFrom" label-width="90px" :inline="false" size="small" :rules="rules">
          ...
          <el-form-item label="申请部门" prop="department">
            <el-input v-model="group.department" style="width: 270px"></el-input>
          </el-form-item>

          <el-form-item label="经办人" prop="person">
            <el-input v-model="group.person" style="width: 270px"></el-input>
          </el-form-item>
          ...
          <el-form-item label="申请类型" prop="type">
            <el-select v-model="group.type" placeholder="请选择" class="tasks" @change="onEducationSelectOption" style="width: 270px">
          ...
          <el-form-item label="审核状态" prop="status">
            <el-input v-model="group.status" style="width: 270px"></el-input>
          </el-form-item>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        person: [{required: true, trigger: 'change', message: '请输入经办人'}],
        applyDate: [{required: true, trigger: 'change', message: '请输入申请时间'}],
        type: [{required: true, trigger: 'change', message: '请输入申请类型'}],
