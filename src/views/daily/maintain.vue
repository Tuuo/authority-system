      ...
      <div slot="content">
        <el-form :model="group" ref="groupFrom" label-width="90px" :inline="false" size="small" :rules="rules">
          ...
          <el-form-item label="门牌号" prop="doorId">
            <el-input v-model="group.doorId" style="width: 370px"></el-input>
          </el-form-item>

          <el-form-item label="申请人" prop="person">
            <el-input v-model="group.person" style="width: 370px"></el-input>
          </el-form-item>
          <el-form-item label="内容" prop="contain">
            <el-input v-model="group.contain" style="width: 370px"></el-input>
          </el-form-item>
          <el-form-item label="报修日期"  prop="mdate">
            <el-col :span="11">
    ...
    <system-dialog :title="handledDialog.title" :visible="handledDialog.visible" :width="handledDialog.width"
      ...
      <div slot="content">
        <el-form :model="handled" ref="noFrom" label-width="90px" :inline="false" size="small" :rules="rules2">
          ...
          <el-form-item label="维修日期" prop="mdate">
            <el-col :span="11">
          ...
          <el-form-item label="维修人" prop="person">
            <el-input v-model="handled.person" style="width: 370px"></el-input>
          </el-form-item>
          <el-form-item label="维修结果" prop="result">
            <el-select v-model="handled.result" placeholder="请选择" class="tasks"
                       @change="onEducationSelectOption" style="width: 370px" >
          ...
          <el-form-item label="说明" prop="illustrate">
            <el-input v-model="handled.illustrate" style="width: 370px"></el-input>
          </el-form-item>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        doorId: [{ required: true, trigger: 'change', message: '请输入门牌号' }],
        person: [{ required: true, trigger: 'change', message: '请输入申请人' }],
        // contain: [{ required: true, trigger: 'change', message: '请输入内容' }],
        mdate: [
          { required: true, trigger: 'change', message: '请输入报修日期' },
          // { validator: validateTime, trigger: "blur" }
        ],
      },
      rules2: {
        person: [{ required: true, trigger: 'change', message: '请输入维修人' }],
        result: [{ required: true, trigger: 'change', message: '请输入维修结果' }],
        mdate: [
          { required: true, trigger: 'change', message: '请输入报修日期' },
          // { validator: validateTime, trigger: "blur" }
        ],
