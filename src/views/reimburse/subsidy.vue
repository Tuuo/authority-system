<template>
  <div class="approval-page">
          ...
          <el-tabs v-model="activeTab" @tab-click="handleTabClick">
            ...
            <el-tab-pane label="外聘费申请" name="gift">
              <el-form :model="searchHoModel" ref="searchHoForm" label-width="100px" :inline="true"
                ...
                <el-form-item>
                  <el-button type="primary" icon="el-icon-search"
                             @click="searchHO(pageNo, pageSize)">查询
                  </el-button>
            ...
            <el-tab-pane label="慰问金申请" name="abroad">
              <el-form :model="searchAoModel" ref="searchAoForm" label-width="100px" :inline="true"
                ...
                <el-form-item>
                  <el-button type="primary" icon="el-icon-search"
                             @click="searchAO(pageNo, pageSize)">查询
                  </el-button>
    ...
    <system-dialog :title="approvalDialog.title" :visible="approvalDialog.visible" :width="approvalDialog.width"
      ...
      <div slot="content">
        <el-form :model="group" ref="groupFrom" label-width="90px" :inline="false" size="small" :rules="rules">
          ...
          <el-form-item label="收款人" prop="person">
            <el-input v-model="group.person" style="width: 360px"></el-input>
          </el-form-item>
          <el-form-item label="付款金额" prop="money">
            <el-input v-model="group.money" style="width: 360px"></el-input>
          </el-form-item>
          <el-form-item label="付款事由" prop="reason">
            <el-input v-model="group.reason" style="width: 360px"></el-input>
          </el-form-item>
          <el-form-item label="类型" prop="type">
            <el-select v-model="group.type" placeholder="请选择" class="tasks" @change="onPaySelectOption" style="width: 360px">
          ...
          <el-form-item label="月份" prop="month">
            <el-col :span="11">
              <el-date-picker v-model="group.month" type="month" placeholder="选择月" value-format="yyyy-MM" style="width: 360px">
              </el-date-picker>
            </el-col>
          </el-form-item>
    ...
    <system-dialog :title="handledDialog.title" :visible="handledDialog.visible" :width="handledDialog.width"
      ...
      <div slot="content">
        <el-form :model="handled" ref="noFrom" label-width="90px" :inline="false" size="small" :rules="rules2">

          <el-form-item label="姓名" prop="name">
            <el-input v-model="handled.name" style="width: 360px"></el-input>
          </el-form-item>
          <el-form-item label="加班时长" prop="time">
            <el-input v-model="handled.time" style="width: 360px"></el-input>
          </el-form-item>
          <el-form-item label="加班类型" prop="type">
            <el-select v-model="handled.type" placeholder="请选择" class="tasks" @change="onOvertimeSelectOption" style="width: 360px">
          ...
          <el-form-item label="加班补助" prop="money">
            <el-input v-model="handled.money" style="width: 360px"></el-input>
          </el-form-item>
          <el-form-item label="在岗人数" prop="num">
            <el-input v-model="handled.num" style="width: 360px"></el-input>
          </el-form-item>
          <el-form-item label="意见" prop="opinion">
            <el-input v-model="handled.opinion" style="width: 360px"></el-input>
          </el-form-item>
          <el-form-item label="月份" prop="month">
            <el-col :span="11">
              <el-date-picker v-model="handled.month" type="month" placeholder="选择月" value-format="yyyy-MM" style="width: 360px">
              </el-date-picker>
            </el-col>
          </el-form-item>
        </el-form>
    ...
    <system-dialog :title="giftDialog.title" :visible="giftDialog.visible" :width="giftDialog.width"
      ...
      <div slot="content">
        <el-form :model="gift" ref="hoFrom" label-width="110px" :inline="false" size="small" :rules="rules3">

          <el-form-item label="姓名" prop="name">
            <el-input v-model="gift.name" style="width: 220px"></el-input>
          </el-form-item>
          <el-form-item label="费用" prop="money">
            <el-input v-model="gift.money" style="width: 220px"></el-input>
          </el-form-item>

          <el-form-item label="签领人签名" prop="signature">
            <el-select v-model="group.signature" placeholder="请选择" class="tasks" @change="onSignatureSelectOption" style="width: 220px">
    ...
    <system-dialog :title="abroadDialog.title" :visible="abroadDialog.visible" :width="abroadDialog.width"
      ...
      <div slot="content">
        <el-form :model="abroad" ref="aoFrom" label-width="110px" :inline="false" size="small" :rules="rules4">

          <el-form-item label="经办人" prop="person">
            <el-input v-model="abroad.person" style="width: 220px"></el-input>
          </el-form-item>
          <el-form-item label="收款人" prop="name">
            <el-input v-model="abroad.name" style="width: 220px"></el-input>
          </el-form-item>
          <el-form-item label="账号" prop="username">
            <el-input v-model="abroad.username" style="width: 220px"></el-input>

          </el-form-item>
          <el-form-item label="付款金额" prop="money">
            <el-input v-model="abroad.money" style="width: 220px"></el-input>

          </el-form-item>
          <el-form-item label="付款事由" prop="reason">
            <el-input v-model="abroad.reason" style="width: 220px"></el-input>
          </el-form-item>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        person: [{required: true, trigger: 'change', message: '请输入收款人'},],
        department: [{required: true, trigger: 'change', message: '请输入申请部门'},],
        money: [{required: true, trigger: 'change', message: '请输入付款金额'},],
        type: [{required: true, trigger: 'change', message: '请输入类型'},],
        reason: [{required: true, trigger: 'change', message: '请选择付款事由'}],
        month: [{required: true, trigger: 'change', message: '请选择月份'}],

      },
      rules2: {
        name: [{required: true, trigger: 'change', message: '请输入姓名'},],
        time: [{required: true, trigger: 'change', message: '请输入加班时长'},],
        type: [{required: true, trigger: 'change', message: '请输入加班类型'},],
        money: [{required: true, trigger: 'change', message: '请输入加班补助'},],
        num: [{required: true, trigger: 'change', message: '请选择在岗人数'}],
        // opinion: [{required: true, trigger: 'change', message: '请选择月份'}],
        month: [{required: true, trigger: 'change', message: '请选择月份'}],

      },
      rules3: {
        name: [{required: true, trigger: 'change', message: '请输入姓名'},],
        money: [{required: true, trigger: 'change', message: '请输入费用'},],
        // opinion: [{required: true, trigger: 'change', message: '请选择月份'}],
        signature: [{required: true, trigger: 'change', message: '请选择签领人签名'}],

      },
      rules4: {
        name: [{required: true, trigger: 'change', message: '请输入收款人'},],
        money: [{required: true, trigger: 'change', message: '请输入付款金额'},],
        username: [{required: true, trigger: 'change', message: '请选择账号'}],
        person: [{required: true, trigger: 'change', message: '请选择经办人'}],
        reason: [{required: true, trigger: 'change', message: '请选择付款事由'}],
